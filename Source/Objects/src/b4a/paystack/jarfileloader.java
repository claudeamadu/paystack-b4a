...
public class jarfileloader extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.paystack.jarfileloader");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.paystack.jarfileloader.class).invoke(this, new Object[] {null});
        else
...
anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _out = null;
 //BA.debugLineNum = 39;BA.debugLine="Public Sub AssetFromJar(FileName As String) As Boo";
 //BA.debugLineNum = 40;BA.debugLine="Try";
try { //BA.debugLineNum = 41;BA.debugLine="If File.Exists(File.DirInternalCache, FileName)";
if (__c.File.Exists(__c.File.getDirInternalCache(),_filename)==__c.False) { 
 //BA.debugLineNum = 42;BA.debugLine="Dim out As OutputStream = File.OpenOutput(File.";
_out = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
_out = __c.File.OpenOutput(__c.File.getDirInternalCache(),_filename,__c.False);
 //BA.debugLineNum = 43;BA.debugLine="File.Copy2(LoadFileFileFromJar(FileName), out)";
...
if (true) return __c.True;
 ...
 //BA.debugLineNum = 47;BA.debugLine="Return True    ' File OK anyway";
if (true) return __c.True;
 };
 } 
       catch (Exception e11) {
...
_bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Dim In As InputStream = LoadFileFileFromJar(FileN";
_in = new anywheresoftware.b4a.objects.streams.File.InputStreamWrapper();
_in = _loadfilefilefromjar(_filename);
 //BA.debugLineNum = 25;BA.debugLine="bmp.Initialize2(In)";
_bmp.Initialize2((java.io.InputStream)(_in.getObject()));
 //BA.debugLineNum = 26;BA.debugLine="In.Close";
_in.Close();
 //BA.debugLineNum = 27;BA.debugLine="Return bmp";
if (true) return _bmp;
...
anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _out = null;
 //BA.debugLineNum = 30;BA.debugLine="Public Sub LoadBitmapSampleFromJar(FileName As Str";
 //BA.debugLineNum = 31;BA.debugLine="If File.Exists(File.DirInternalCache, FileName) =";
if (__c.File.Exists(__c.File.getDirInternalCache(),_filename)==__c.False) { 
 //BA.debugLineNum = 32;BA.debugLine="Dim out As OutputStream = File.OpenOutput(File.D";
_out = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
_out = __c.File.OpenOutput(__c.File.getDirInternalCache(),_filename,__c.False);
 //BA.debugLineNum = 33;BA.debugLine="File.Copy2(LoadFileFileFromJar(FileName), out)";
__c.File.Copy2((java.io.InputStream)(_loadfilefilefromjar(_filename).getObject()),(java.io.OutputStream)(_out.getObject()));
 //BA.debugLineNum = 34;BA.debugLine="out.Close";
_out.Close();
 };
 //BA.debugLineNum = 36;BA.debugLine="Return LoadBitmapSample(File.DirInternalCache, Fi";
...
anywheresoftware.b4j.object.JavaObject _ninedrawable = null;
 //BA.debugLineNum = 55;BA.debugLine="Public Sub LoadNinePatchDrawable(FileName As Strin";
 //BA.debugLineNum = 56;BA.debugLine="Dim b As Bitmap = LoadBitmapFromJar(FileName)";
_b = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
_b = _loadbitmapfromjar(_filename);
 //BA.debugLineNum = 57;BA.debugLine="Dim jo As JavaObject = b";
...
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_b.getObject()));
 //BA.debugLineNum = 58;BA.debugLine="Dim chunk() As Byte = jo.RunMethod(\"getNinePatchC";
_chunk = (byte[])(_jo.RunMethod("getNinePatchChunk",(Object[])(__c.Null)));
 //BA.debugLineNum = 59;BA.debugLine="Dim nineDrawable As JavaObject";
_ninedrawable = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 60;BA.debugLine="nineDrawable.InitializeNewInstance(\"android.graph";
_ninedrawable.InitializeNewInstance("android.graphics.drawable.NinePatchDrawable",new Object[]{__c.Null,(Object)(_b.getObject()),(Object)(_chunk),__c.Null,(Object)("")});
 //BA.debugLineNum = 61;BA.debugLine="Return nineDrawable";
